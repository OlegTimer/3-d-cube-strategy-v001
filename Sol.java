...
public class Sol extends JPanel implements MouseWheelListener, MouseMotionListener {
    ...
    public static int zeppfiredaly = 4;
    ...
    public static int timersleep = 20; //1 cycle ms delay
    ...
    public static ArrayList flashlist;
    public static ArrayList reslist;
    ...
    public static int mapwidth = 20;//inverted to ns
    public static int maplength = 20;//inverted to ew
                            ...
                            if (hdes>0) {
                                ...
                                if (arr[14] == 9||arr[14] == 2009) {
                                    ...
                                    if (arr[21]==1){ g.setColor(new Color(255, 255, 0));}else{
                                        g.setColor(new Color(255, 255, 255));}
                                    xd=7*d/20;yd=7*d/20;
                                    g.fillOval(xsr+xd, yscr+yd, 6*d/20, 6*d/20);
                                }//if unit num9 end
                                        ...
                                        if (xsr * d < d * blocksmumwidth && yscr * d < d * blocksmumwidth) {
                                            ...
                                            if (arr[14] == 4||arr[14] ==2004) {//air unit num4
                                                ...
                                                if (arr[10] == 1) {//air unit sel
                                                 ...
                                                 hp = arr[18];//hp
                                                 healthtotal = getunithp(arr[14]);
                                                g.setColor(new Color(255, 255, 255));
                                                g.fillRect(xsr+d/10-2,yscr+7*d/10-2,4*d/5+4,d/10+4);
                                                if (arr[14]<2000)   {  g.setColor(new Color(175, 65, 175));}
                                                else{ g.setColor(new Color(0, 0, 0));}
                                                 wdth = 1.0*hp/healthtotal*(4*d/5);
                                                 w = (int)wdth;
                                                g.fillRect(xsr+d/10,yscr+7*d/10,w,d/10);//hp end
                                            }
                                        }
...
String text3=unitscountpl1+"/"+unitsnum/2+" "+buildcountpl1 +"/"+buildnum/2+" "
        +buildshootcountpl1+"/" +shootingbuildforone+" "+hqnump1+"/2";
         ...
         if   (timeron>0)
         {  ys=ys+ds; g.drawString(   "<time is on> 'n' to stop", d, ys);}
         else{ ys=ys+ds; g.drawString(   "<paused> 'n' to go", d, ys);}
         //
            ...
            for (int i = 0; i < unitlist.size(); i++) {
                arr = (int[]) unitlist.get(i);
                if (arr[10]==1){singleselect=i;countsingle++;}
            }
            for (int i = 0; i < buildlist.size(); i++) {
                arr = (int[]) buildlist.get(i);
                if (arr[10]==1){singleselect=-i; countsingle++;
            ...
            if (countsingle==1){
                ...
                if (arr[14]==1003||arr[14]==3003) {
                    ...
                    if (unitscountpl1 <unitsnum/2&& moneypl1>=getprice(3)&&arr[26]==0){//eng in hq
                        g.setColor(new Color(0, 150, 0));}
                ...
                if (arr[14]==1008||arr[14]==3008) {//barracks
                    ...
                    if (unitscountpl1 <unitsnum/2&&moneypl1>=getprice(3)&&arr[26]==0){//eng in barracks
                        g.setColor(new Color(0, 150, 0));}
                    else{ g.setColor(new Color(150, 150, 150));}
                    g.fillRect(d+2, st, d,d);
                    g.setColor(new Color(0, 0, 0));
                    ...
                    if (unitscountpl1 <unitsnum/2&&moneypl1>=getprice(nm)&&arr[26]==0){
                        g.setColor(new Color(0, 150, 0));}
                    else{ g.setColor(new Color(150, 150, 150));}
              ...
              int yd2;
                ...
                if (arr[14]==3&&arr[11]==-1||arr[14]==2003&&arr[11]==-1) { //eng
                    ...
                    if (engswitch>0){ //building eng start
                        int nm = 1003; //hq
                    if (hqnump1<2&&buildcountpl1<buildnum/2&&moneypl1 >= getprice(nm) && arr[26] == 0) {//
                        g.setColor(new Color(0, 150, 0));
                    } else {
                        g.setColor(new Color(150, 150, 150));
                    }
                    ...
                    g.drawString(getprice(nm) + "", d + 2, ys);
                     ...
                     nm = 1001;
                    ys = ys + 5; //mine
                    if (buildcountpl1<buildnum/2&&moneypl1 >= getprice(nm) && arr[26] == 0) {
                        g.setColor(new Color(0, 150, 0));
                    } else {
                        g.setColor(new Color(150, 150, 150));
                    }
                    ...
                    nm = 1005;
                    ys = ys + 5; //b air def
   if (buildshootcountpl1 <shootingbuildforone&& buildcountpl1<buildnum/2&&moneypl1 >= getprice(nm) && arr[26] == 0) {
                        g.setColor(new Color(0, 150, 0));
                    } else {
                        g.setColor(new Color(150, 150, 150));
                    }
                    ...
                    nm = 4001;
                    ys = ys + 5; //medic
                    if (moneypl1 >= getprice(nm) && arr[26] == 0) {
                        g.setColor(new Color(0, 150, 0));
                    } else {
                        g.setColor(new Color(150, 150, 150));
                    }
...
if (arr[25]==0){
    ...
    if (arr[17]==0){bonus=bonus+" f";}else{bonus=bonus+" h";}
            ...
            ys= (int)(8.59*d+ds);
           mapposx=d-2;  mapposy = ys+2;//minimap 200*200 pixels by default in 1024*768
            Rectangle r = jFrame.getBounds();
          ...
          if (maplength>blocksmumwidth&&mapwidth>blocksmumwidth){
            ...
            g.setColor(new Color(0, 0, 0));
          g.fillRect(mapposx, mapposy, 200,200);
          int xu=-1; int yu=-1;
            for (int i = 0; i < unitlist.size(); i++) {
                arr = (int[]) unitlist.get(i);
                if (arr[14]<1000){//if pl1
                 yu = arr[2];   xu=arr[3];
...
g.drawRect(mapposx+ewpos*mapdot, mapposy+nspos*mapdot, mapdot*blocksmumwidth,mapdot*blocksmumwidth);
            ...
            g.drawString(   "$: "+moneypl1, d+3, ys+ds); //upper minimap $
            g2d.dispose();
        }
    }
...
//third column
  ...
  //  JOptionPane.showMessageDialog(null, nm, "w", JOptionPane.PLAIN_MESSAGE);
    ...
    {
        if (unitscountpl1<unitsnum/2 &&arr[14]==1003){//pl1
            if (moneypl1>=getprice(nm)){//
    ...
    if (arr[14]==1008&&arr[26]==0||arr[14]==3008&&arr[26]==0){//barracks if not building now
        if (unitscountpl1<unitsnum/2&&arr[14]==1008){//pl1
            if (moneypl1>=getprice(nm)){//
 ...
 if (nm==1005||nm==1006||nm==1007){buildshootcountpl1++;}
    ...
    public static   void   mapgo(){
        ...
        nspos=((yrel-mapposy)/mapdot)-3;
        ewpos=((xrel-w-mapdot)/mapdot)-3;
        fmove();
    }
    ...
    static void optionsread(){
        ...
        {System.out.println(e);
            ...
            try (BufferedWriter writer = new BufferedWriter(new FileWriter(filep2))) {
                String s = blocksmumwidth+" "+d+" "+fscr+" "+xres+" "+yres+" "+aihard;
                writer.write(s);
                writer.write(nl);
  s = "blocks_num_screen "+"block_side(pix) "+"fullscreen(1yes;0no) "+"x_resolution y_resolution "+"AI_lvl";
                writer.write(s);
                writer.write(nl);
        ...
        singleselect=0;
            ...
            if (zpos>=mapheight-1) {//air unit start
                if (unitlist!=null){
                    ...
                    for (int i = 0; i < unitlist.size(); i++) {
                        arr = (int[]) unitlist.get(i);
                        if (arr[1]==mapheight-1&&arr[14] > 2 && arr[14] < 2000) {//air unit
                            cc=0;
            ...
            if (unitlist!=null){
                ...
                for (int i = 0; i < unitlist.size(); i++) {
                 ...
                 ArrayList templ = new ArrayList();
                    ...
                    if (temph<mapheight-1&&arr[14] > 2 && arr[14] < 2000) {//gr unit
                        cc=0;
                        if (arr[2] >= upscrcorner && arr[2] <= downscrcorner && arr[3] >= leftscrcorner && arr[3] <= rightscrcorner) {cc++;}
                        if (arr[5] >= upscrcorner && arr[5] <= downscrcorner && arr[6] >= leftscrcorner && arr[6] <= rightscrcorner) {cc++;}
                        if (arr[8] >= upscrcorner && arr[8] <= downscrcorner && arr[9] >= leftscrcorner && arr[9] <= rightscrcorner) {cc++;}
 ...
 if (arr[1]==zpos||arr[4]==zpos||arr[7]==zpos){temph=1;}//if unit exist on such slice with any part (block)
        ...
        if (zpos==mapheight) {//bld top start
            if (buildlist!=null){
                ...
                for (int i = 0; i < buildlist.size(); i++) {
                    ...
                    if (temph<mapheight-1&&arr[14] > 1000 && arr[14] < 2000) {//bld
                        cc=0;
                        if (arr[2] >= upscrcorner && arr[2] <= downscrcorner && arr[3] >= leftscrcorner && arr[3] <= rightscrcorner) {cc++;}
                        if (arr[5] >= upscrcorner && arr[5] <= downscrcorner && arr[6] >= leftscrcorner && arr[6] <= rightscrcorner) {cc++;}
                        if (arr[8] >= upscrcorner && arr[8] <= downscrcorner && arr[9] >= leftscrcorner && arr[9] <= rightscrcorner) {cc++;}
    ...
    public static void  deleteselectedunits(){
        ...
        for (int i = 0; i <unitlist.size(); i++){
            ...
            if (arr[10]==1){unitlist.remove(i); deleteselectedunits();}
        }

        for (int i = 0; i <buildlist.size(); i++){
            arr = (int[]) Sol.buildlist.get(i);
            if (arr[10]==1){buildlist.remove(i); deleteselectedunits();}
        }
    ...
    public static int   getunitspeed(int b){
        ...
        result=zepp_step_time; //for test
        if (b==9||b==2009){result=car_step_time*2;}
        return result;
    }
    ...
    public static int   getunithp(int b){
       ...
       if (b==1010||b==3010){result=eng_hp*2;}
        return result;
    }
    ...
    public static int   getfiredelay(int b){
        int result=0;
...
if (dir==2){x=-x+d;}
 ...
 if (n==5){res = "air defence";}
    ...
    public static int getpspeedbuild (int b){
        ...
        if (b==8||b==2008){res=engspeedbuild*3;}
        if (b==9||b==2009){res=engspeedbuild*3;}
...
// System.out.println("iw:"+iw+" ie:"+ie+" in:"+in+" is:"+is);
    ...
    private static JDialog createDialog(final JFrame frame){
        int arr []; arr = (int[]) unitlist.get(singleselect); //we already know it's eng
      ...
      JLabel text1 = new JLabel("");
        ...
        ub.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                modelDialog.setVisible(false);
             arr[31]=1;   unitlist.set(singleselect,arr); engdig(singleselect);
        ...
        lb.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                modelDialog.setVisible(false);
                arr[31]=0;   unitlist.set(singleselect,arr); engdig(singleselect);
        ...
        db.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                modelDialog.setVisible(false);
        arr[31]=3;   unitlist.set(singleselect,arr); engdig(singleselect);
               // JOptionPane.showMessageDialog(null, "d", "w", JOptionPane.PLAIN_MESSAGE);
            }
        });
        panel1.add(db);
        ...
        rb.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                modelDialog.setVisible(false);
                arr[31]=2;   unitlist.set(singleselect,arr); engdig(singleselect);
        ...
        ub2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                modelDialog.setVisible(false);
                arr[31]=5;   unitlist.set(singleselect,arr); engdig(singleselect);
        ...
        lb2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                modelDialog.setVisible(false);
                arr[31]=4;   unitlist.set(singleselect,arr); engdig(singleselect);
        ...
        db2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                modelDialog.setVisible(false);
                arr[31]=7;   unitlist.set(singleselect,arr); engdig(singleselect);
        ...
        rb2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                modelDialog.setVisible(false);
                arr[31]=6;   unitlist.set(singleselect,arr); engdig(singleselect);
...
// JOptionPane.showMessageDialog(null, " current process terminated, running in new game mode", "i", JOptionPane.PLAIN_MESSAGE);
 ...
 JOptionPane.showMessageDialog(null, "options.txt is not a map!", "e", JOptionPane.PLAIN_MESSAGE);
       ...
       // un12.setForeground(new Color(0, 0, 0));
        ...
        un6.setBackground(new Color(200, 200, 200));
 ...
 public static void   multiplgo(){
     JOptionPane.showMessageDialog(null, "in the future", "multiplayer", JOptionPane.PLAIN_MESSAGE);
 }
  ...
  JOptionPane.showMessageDialog(null, "by OlegTim", "extra", JOptionPane.PLAIN_MESSAGE);
    ...
    public static void   fastbattle(){
        ...
        brush = 2003; unit.z = 10; unit.y = 13; unit.x = 15;
        unit.go();
 ...
 public   static void  getai(){
       ...
       if (t>1&&t<51)     {
           ...
           String nl = "\r\n";
           try (BufferedWriter writer = new BufferedWriter(new FileWriter(filep2))) {
                s = blocksmumwidth+" "+d+" "+fscr+" "+xres+" "+yres+" "+aihard;
               writer.write(s);
               writer.write(nl);
               s = "blocks_num_screen "+"block_side(pix) "+"fullscreen(1yes;0no) "+"x_resolution y_resolution "+"AI_lvl";
               writer.write(s);
    ...
    public static void finmsg(int i){
        if (i==1||i==2){//which of pl lost all hq (for example, "1" pl1 has zero and pl2 has 1-2 hq
 String s="";
 if (i==1){s="Player 2 has won.";
     JOptionPane.showMessageDialog(null, s, "game final", JOptionPane.WARNING_MESSAGE);
 }
 if (i==2){s="Player 1 has won! Good!";
     JOptionPane.showMessageDialog(null, s, "game final", JOptionPane.INFORMATION_MESSAGE);
 }
    }}
